...
<div class="staff-dashboard" style="--primary-color: <?php echo $theme_color; ?>;">
        ...
        <div class="header-content">
            <div class="header-left">
                <div class="welcome-section">
                    ...
                    <p class="welcome-text">Welcome back, <strong><?php echo htmlspecialchars($staff_info['name']); ?></strong>! Support hospital operations and maintain quality service standards.</p>
                </div>
            ...
            <div class="attendance-info">
                ...
                <?php if ($my_attendance): ?>
                    ...
                    <div class="attendance-details">
                        <span>Working Hours: 8.5 hrs</span>
    ...
    <div class="stats-section">
        <div class="stats-grid">
            <div class="stat-card patients">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-change positive">
                        ...
                        <span>+<?php echo rand(3, 8); ?> this week</span>
                    </div>
                </div>
            ...
            <div class="stat-card hours">
                ...
                <div class="stat-chart">
                    <canvas id="hoursChart" width="60" height="30"></canvas>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="actions-grid">
            <a href="modules/patients.php" class="action-card">
                ...
                <div class="action-content">
                    ...
                    <p>Assist patients with queries and support</p>
                </div>
            ...
            <a href="modules/equipment.php" class="action-card">
                ...
                <div class="action-content">
                    ...
                    <p>Monitor and maintain hospital equipment</p>
                </div>
                <div class="action-arrow">
                    <i class="fa fa-arrow-right"></i>
                </div>
            ...
            <a href="modules/maintenance.php" class="action-card">
                <div class="action-icon">
                    <i class="fa fa-wrench"></i>
                </div>
                <div class="action-content">
                    <h4>Maintenance Log</h4>
                    <p>Record and track maintenance activities</p>
                </div>
                <div class="action-arrow">
                    <i class="fa fa-arrow-right"></i>
                </div>
            ...
            <a href="modules/reports.php" class="action-card">
                ...
                <div class="action-content">
                    <h4>Daily Reports</h4>
                    <p>Generate and view daily activity reports</p>
                </div>
                <div class="action-arrow">
                    <i class="fa fa-arrow-right"></i>
                </div>
...
function initializeMiniCharts() {
    ...
    const charts = ['patientsChart', 'appointmentsChart', 'tasksChart', 'hoursChart'];
